...
#define FD628_DIO_D_OUT                                 set_dio_gpio(1)  		/* 设置DIO为输出方向 */
#define FD628_DIO_D_IN                                  set_dio_gpio(0)         /* 设置DIO为输入方向 */
