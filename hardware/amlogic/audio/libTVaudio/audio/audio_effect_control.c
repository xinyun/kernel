...
int load_EQ_lib(void) {
    ...
    EQ_process = (int(*)(short*,short*,int))dlsym(gEQLibHandler, "HPEQ_process_api");
    if (EQ_process == NULL) {
    ...
    EQ_setParameter = (int(*)(int, int, int, int, int))dlsym(gEQLibHandler, "HPEQ_setParameter_api");
    if (EQ_setParameter == NULL) {
        ALOGE("%s, fail find fun HPEQ_setParameter_api\n", __FUNCTION__);
        goto Error;
    }
    EQ_getParameter = (int(*)(int*, int*, int*, int*, int*))dlsym(gEQLibHandler, "HPEQ_getParameter_api");
...
int load_SRS_lib(void) {
    ...
    SRS_process = (int(*)(short*,short*,int))dlsym(gSRSLibHandler, "SRS_process_api");
    if (SRS_process == NULL) {
    ...
    SRS_setParameter = (int(*)(int, float, float, float, float))dlsym(gSRSLibHandler, "SRS_setParameter_api");
    if (SRS_setParameter == NULL) {
        ALOGE("%s, fail find fun SRS_setParameter_api()\n", __FUNCTION__);
        goto Error;
    }
    SRS_getParameter = (int(*)(int*, float*, float*, float*, float*))dlsym(gSRSLibHandler, "SRS_getParameter_api");
    if (SRS_getParameter == NULL) {
        ALOGE("%s, fail find fun SRS_getParameter_api()\n", __FUNCTION__);
        goto Error;
    }
    SRS_TRUEBASS_ENABLE = (int(*)(int))dlsym(gSRSLibHandler, "SRS_TRUEBASS_ENABLE_api");
    if (SRS_TRUEBASS_ENABLE == NULL) {
        ALOGE("%s, fail find fun SRS_TRUEBASS_ENABLE_api()\n", __FUNCTION__);
        goto Error;
    }
    SRS_DIALOGCLARITY_ENABLE = (int(*)(int))dlsym(gSRSLibHandler, "SRS_DIALOGCLARITY_ENABLE_api");
    if (SRS_DIALOGCLARITY_ENABLE == NULL) {
        ALOGE("%s, fail find fun SRS_DIALOGCLARITY_ENABLE_api\n", __FUNCTION__);
        goto Error;
    }
    SRS_SURROUND_ENABLE = (int(*)(int))dlsym(gSRSLibHandler, "SRS_SURROUND_ENABLE_api");
